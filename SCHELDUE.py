...
class Scheduler(SchedulerInterface):
    ...
    def schedule(self) -> SchedulerOutput:
        ...
        # ===============================================================
        # Re-sort the waiting queue to prioritize shorter prompts.
        # The self.waiting.requests attribute holds the list of requests.
        if self.waiting:
            self.waiting.requests.sort(key=lambda req: len(req.prompt_token_ids))
        # ===============================================================
        # END: CUSTOM SCHEDULING LOGIC
        # ===============================================================
